...
class TestBinanceFuture(TestCase):
    def test_fetch_ohlcv_initial(self):
        ...
        self.assertEqual(df['op'].iloc[0], 10000.0)
        self.assertEqual(df['hi'].iloc[0], 10412.65)
        self.assertEqual(df['lo'].iloc[0], 10000.00)
        self.assertEqual(df['cl'].iloc[0], 10391.63)
        self.assertEqual(df['volume'].iloc[0], 3096.291)
